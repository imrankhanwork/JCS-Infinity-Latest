...
const LearnCode = () => {
  const languages = [
    {
      name: "JavaScript",
      description: "Build dynamic web applications and interactive user interfaces",
    ...
    {
      name: "React",
      description: "Create powerful and scalable frontend applications",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Master different programming languages with our hands-on projects and expert guidance
          </p>
        </div>
