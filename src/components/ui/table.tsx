...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-muted/40 text-muted-foreground [&_tr]:border-b [&_th]:text-xs [&_th]:uppercase [&_th]:tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 py-3 text-left font-medium text-muted-foreground align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
